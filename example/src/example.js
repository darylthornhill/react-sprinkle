...
import reactSprinkle from '../../index.js';
...
class ExampleComponent extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <h1>Sprinkle in action</h1>
                <p>
                    In this example we are using a custom html tag called <b>test-html-component</b>
                </p>
...
reactSprinkle(ExampleComponent, 'test-html-component');
